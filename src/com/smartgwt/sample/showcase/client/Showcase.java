...
public class Showcase implements EntryPoint, HistoryListener, ShowcaseNavigator {
    ...
    public void onModuleLoad() {
        ...
        if (useDesktopMode) {
            ...
            final int fontIncreaseValue = Integer.parseInt(fontIncreaseParameters[1]);
            final int sizeIncreaseValue = Integer.parseInt(sizeIncreaseParameters[1]);
