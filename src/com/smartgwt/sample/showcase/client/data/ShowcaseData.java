    ...
    private ExplorerTreeNode[] getData() {
        if (data == null) {
            ...
            data.addAll(Arrays.asList(new ExplorerTreeNode[] {
                    new ExplorerTreeNode(M.homeNodeName(), "首页", "root", "silk/house.png", null, true, idSuffix),
                    ...
                    new ExplorerTreeNode("单元格组件", "featured-grid-cell-widgets", "featured-category", null, new GridCellWidgetsSample.Factory(), true, idSuffix),
                    new ExplorerTreeNode("测试页面", "test-widgets", "featured-category", null, new TestSample.Factory(), true, idSuffix),
                    ...
                    new ExplorerTreeNode("打印表格", "featured-print-grid", "featured-category", "silk/printer.png", new PrintingSample.Factory(), true, idSuffix),

                    // Disabled for now. We don't want to expose this folder until we have a certain number of samples complete.
                    new ExplorerTreeNode("移动例子", "mobile", "root", "silk/phone.png", null, true, idSuffix),   
                    new ExplorerTreeNode("响应式设计", "responsive-design", "mobile", "silk/calendar.png", new ResponsiveDesign.Factory(), false, idSuffix, "5.0"),
                    ...
                    new ExplorerTreeNode("表头扩展", "featured-grid-header-span", "featured-category", null, new GridHeaderSpansSample.Factory(), true, idSuffix),
                    ...
                    new ExplorerTreeNode("表格求和", "grid-summaries-featured-category", "featured-category", "crystal/16/apps/tooloptions.png", new GridSummariesSample.Factory(), true, idSuffix),
